    ...
    if (this.state.product) {
      ...
      return (
        <div className = 'product-details card col-md-12 col-12'>
          ...
          <button className = 'col-6 col-sm-3 back-button btn btn-primary' onClick = {this.backToList}>Back to catalog</button>
          <div className = 'product-details-top row'>
            <div className = 'product-details-img-container col-12 col-sm-6'>
            ...
            <div className = 'product-details-info col-12 col-sm-6'>
