          ...
          <div className = 'offset-sm-2 col-sm-8 col-12 form-group'>
            <div className = 'input-group mb-3'>
              <div className = 'col-12'>
                ...
                <input autoComplete='off' name='cardName' id = 'name' className = {`col-8 form-control ${this.state.nameValidation.nameCheck}`} type='text' placeholder = 'Name On Card' onChange = {this.handleChange} value = {this.state.name}></input>
            ...
            <div className = 'input-group mb-3'>
              <div className = 'col-sm-8 col-12 mr-3'>
                <input autoComplete='off' name='cardNumber' id = 'creditCard' className = {`col-12 form-control ${this.state.cardValidation.cardCheck}`} type='text' placeholder = 'Credit Card Number' onChange = {this.handleChange} value = {this.state.creditCard} maxLength='16'></input>
              ...
              <div className = 'col-sm-3 col-12'>
                <input autoComplete='off' id='creditCardCVV' name='cardCVV' className = {`col-12 form-control ${this.state.cvvValidation.cvvCheck}`} type='text' placeholder = 'CVV' onChange = {this.handleChange} value = {this.state.creditCardCVV}></input>
            ...
            <div className = 'shipping input-group mb-3'>
              <div className = 'col-12'>
                <textarea autoComplete='off' name='cardAddress' id = 'shippingAddress' className = {`col-12 form-control ${this.state.addressValidation.addressCheck}`} type='text' placeholder = 'Shipping Address' onChange = {this.handleChange} value = {this.state.shippingAddress}></textarea>
